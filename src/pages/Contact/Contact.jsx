...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "e939f694-d122-4039-900a-a0b2285d3729"); // Replace with your Web3Forms access key
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">riorialdy13@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Indonesia, Batam, Kepulauan Riau</p>
                  </div>
                </div>
              </div>
            </div>
